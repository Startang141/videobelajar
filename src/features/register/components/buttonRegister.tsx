...
const ButtonRegister = () => {
  return (
    <>
      ...
      <button
        type="button"
        className="flex flex-row gap-2 text-md w-full justify-center bg-white text-gray-600 border-gray-200 border rounded-md font-bold py-2.5 hover:bg-slate-50"
      >
